                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sessions.store') }}">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control custom-form-control @error('course_id') is-invalid @enderror" id="course" name="course_id">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="datetime-local" class="form-control custom-form-control @error('date_fin') is-invalid @enderror" id="date_fin" name="date_fin" required>
                                @error('date_fin')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
