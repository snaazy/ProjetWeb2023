...
<div class="row how-to-use">
    ...
    <div class="col-md-4">
        ...
        <p>Utilisez la barre de recherche pour trouver la formation qui vous intéresse. Vous pouvez filtrer les résultats en fonction de la ville, du domaine d'études, ou du niveau de formation.</p>
    </div>
    ...
    <div class="col-md-4">
        ...
        <p>Une fois que vous avez trouvé la formation qui vous intéresse, cliquez sur le bouton "Voir le planning" pour consulter les horaires des cours et des examens.</p>
    </div>
    ...
    <div class="col-md-4">
        ...
        <p>Si vous êtes étudiant, vous pouvez également consulter la liste des cours de votre formation en cliquant sur le bouton "Voir les cours de ma formation".</p>
    </div>
</div>
@endsection