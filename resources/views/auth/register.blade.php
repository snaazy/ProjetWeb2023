                ...
                <div class="card-body px-4">
                    <form method="post" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="nom" class="form-control rounded-pill @error('nom') is-invalid @enderror" value="{{ old('nom') }}">
                            @error('nom')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="prenom" class="form-control rounded-pill @error('prenom') is-invalid @enderror" value="{{ old('prenom') }}">
                            @error('prenom')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="login" class="form-control rounded-pill @error('login') is-invalid @enderror" value="{{ old('login') }}">
                            @error('login')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="password" name="mdp" class="form-control rounded-pill @error('mdp') is-invalid @enderror">
                            @error('mdp')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="formation_id" class="orm-control rounded-pill @error('formation_id') is-invalid @enderror">
                                ...
                                <div class="form-group mb-4">
                                    <button type="submit" class="btn btn-primary btn-block rounded-pill">Créer un compte</button>
                                </div>
                            </form>
                        </div>
                        <div class="card-footer bg-white text-center pt-0">
                            <p class="mb-0">Vous avez déjà un compte ? <a href="{{ route('login') }}" class="link-primary">Se connecter</a></p>
                        </div>
                    </div>
                </div>
            </div>
