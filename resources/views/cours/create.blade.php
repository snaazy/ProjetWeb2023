...
<div class="form-group">
    ...
    <input type="text" name="intitule" id="intitule" class="form-control form-control-lg @error('intitule') is-invalid @enderror" value="{{ old('intitule') }}" required>
    @error('intitule')
...
<div class="form-group">
    ...
    <select class="form-control form-control-lg @error('formation_id') is-invalid @enderror" id="formation_id" name="formation_id" required>
...
<div class="form-group">
    ...
    <select class="form-control form-control-lg @error('user_id') is-invalid @enderror" id="user_id" name="user_id" required>
