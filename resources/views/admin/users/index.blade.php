                ...
                <form method="GET" action="{{ route('admin.users.index') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="enseignant" {{ request('type') == 'enseignant' ? 'selected' : '' }}>Enseignant
                            </option>
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            @if ($user->type === null)
                                                <form action="{{ route('admin.users.approve', $user->id) }}" method="POST">
                                                    @csrf
                                                    <button type="submit"
                                                        class="btn btn-success btn-sm mb-2">Approuver</button>
                                                </form>
                                                ...
                                                <form action="{{ route('admin.users.refuse', $user->id) }}" method="post"
                                                    ...
                                                    @method('PATCH')
                                                    <button type="submit"
                                                        class="btn btn-danger btn-sm mb-2">Refuser</button>
                                                </form>
                                            @endif
